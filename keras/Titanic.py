...
# Reading dataset
train = pd.read_csv("C:\\Users\\bitcamp\\Downloads\\titanic\\train.csv")
test = pd.read_csv("C:\\Users\\bitcamp\\Downloads\\titanic\\test.csv")
...
# List to series
data_check =  pd.read_csv("C:\\Users\\bitcamp\\Downloads\\titanic\\test.csv")
...
temp = pd.DataFrame(pd.read_csv("C:\\Users\\bitcamp\\Downloads\\titanic\\test.csv")['PassengerId'])
temp['Survived'] = data_check['final']
temp.to_csv("D:\\submission.csv", index = False)