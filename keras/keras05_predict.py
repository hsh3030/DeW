...
x4 = np.array([151,152,153,154,155,156,157,158,159,160,161,162,163,164,165])
x5 = np.array(range(30,50)) #range(30, 50) [50-1] 30~49
...
y_predict = model.predict(x5) # predict : 예측치 확인
print(y_predict)
