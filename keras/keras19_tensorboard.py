...
model.add(Dense(10, input_shape = (3, ), activation = 'relu', kernel_regularizer=regularizers.l2(0.001))) # input과 output값 변경
...
model.fit(x_train, y_train, epochs = 300, batch_size=8, callbacks=[early_stopping, th_hist], validation_data=(x_val, y_val))
